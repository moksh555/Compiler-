public class Expr extends SuperToken implements Token {
    Name name;
    int intlit;
    float floatlit;
    String charOrStr;
        ...
        switch (cond){
            ...
            case 2:
                ...
                if (fn == null || !fn.isMethod) {
                    System.out.print("Error: No method found by the name of " + fnName +".\nOn Line: \n"+ toString(0));
                    System.exit(0);
                }
                return fn.type;
            case 3:
            ...
            case 10:
                ...
                if (prefixOperator.equals("~")){
                    if (!isCoercible(VarType.Bool, exprType)){
                        System.out.print(" Error: " + prefixOperator + " is incompatible with variables of type " + exprType +".\nOn Line: \n"+ toString(0));
                        System.exit(0);
                    }
                }else {
            ...
            case 11:
                ...
                if (singleExpr.typeCheck().equals(VarType.Int)){
                    if (numericalConversion){
                        System.out.print(" Unable to cast expression of type " + exprType + " to " + castType +".\nOn Line: \n"+ toString(0));
                        System.exit(0);
                    }
            ...
            case 13:
                ...
                if (!conditionalType.equals(VarType.Bool) && !conditionalType.equals(VarType.Int)){
                    System.out.print(" Error: Incompatible types: " + conditionalType + " cannot be converted to Boolean" +".\nOn Line: \n"+ toString(0));
                    System.exit(0);
                }
                if (!expr1Type.equals(expr2Type)){
                    System.out.print(" Error: Incompatible types: expr1 type " + expr1Type + " doesn't match expr2 type " + expr2Type +".\nOn Line: \n"+ toString(0));
                    System.exit(0);
                }
                return expr1Type;
            default:
